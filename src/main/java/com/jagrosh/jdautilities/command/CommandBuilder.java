...
public class CommandBuilder
{
     ...
     *
     * <p>An alternate method {@link CommandBuilder#build(BiConsumer)} exists if you wish to retrieve information
     ...
     *
     * @param  execution
     *         The {@link BiConsumer} that runs on  {@link Command#execute(CommandEvent)}.
     *
     * @return The Command built
     */
