...
public interface CommandListener {
    ...
    /**
     * Called when a {@link SlashCommand SlashCommand}
     * catches a {@link Throwable Throwable} <b>during execution</b>.
     *
     * <p>This doesn't account for exceptions thrown during other pre-checks,
     * and should not be treated as such!
     * <p>
     * The {@link NullPointerException NullPointerException} thrown will not be caught by this method!
     *
     * @param event     The CommandEvent that triggered the Command
     * @param command   The Command that was triggered
     * @param throwable The Throwable thrown during Command execution
    ...
    /**
     * Called when a {@link ContextMenu} catches a {@link Throwable Throwable} <b>during execution</b>.
     *
     * <p>This doesn't account for exceptions thrown during other pre-checks,
     * and should not be treated as such!
     * <p>
